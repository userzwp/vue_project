...
<el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTabs" 
@tab-click="tabClick">
    <el-tab-pane label="基本信息" name="0">
        <el-form-item label="商品名称" prop="goods_name">
         ...
         <el-form-item label="商品数量" prop="goods_number">
          ...
          <el-form-item label="商品分类" prop="goods_cat" type="string">
                <el-cascader
    ...
    <el-tab-pane label="商品参数" name="1">
        <el-form-item :label="item.attr_name" v-for="item in manyTableData" :key="item.attr_id">
            <el-checkbox-group v-model="item.attr_vals">
              <el-checkbox v-for="(cd,i) in item.attr_vals" :key="i" :label="cd" border>
  ...
  <el-dialog
  title="图片预览"
  :visible.sync="previewVisible"  width="40%">
