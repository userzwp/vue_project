<template>
  ...
  width="40%" @close="addresClosed">
  <el-form :model="addresForm" :rules="addresRules" ref="addresRef" label-width="100px">
  <el-form-item label="省市区/县" prop="address1">
   <el-cascader :options="cityData" v-model="addresForm.address1"></el-cascader>
  </el-form-item>
...
export default {
     ...
     methods:{
       ...
       this.orderList = res.data.goods
         ...
         addresClosed(){
             this.$refs.addresRef.resetFields()
         },
        async showProgress(){
